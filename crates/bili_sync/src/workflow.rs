...
pub async fn fetch_video_details(
    ...
    let tasks = videos_model
        ...
        .map(|video_model| async move {
            ...
            let video = Video::new(bili_client, video_model.bvid.as_str(), config.download_credential());
...
pub async fn fetch_page_video(
    ...
    let bili_video = Video::new(cx.bili_client, video_model.bvid.as_str(), cx.config.download_credential());
